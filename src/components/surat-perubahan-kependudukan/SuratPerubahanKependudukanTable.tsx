...
import type {
    SuratPerubahanKependudukan,
    SuratPerubahanKependudukanSortableKeys,
                ...
                <table className="min-w-full text-left text-sm">
                    <thead className="bg-gray-50">
                        <tr className="text-xs font-semibold uppercase tracking-wider text-slate-700">
                            ...
                            <SortableHeader columnKey="nik" onSort={onSort} queryParams={queryParams}>
                                NIK
                            </SortableHeader>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {isLoading
                            ...
                            : userList.length === 0
                                ? renderState('Tidak ada data surat perubahan kependudukan.', 6)
                                : userList.map((surat, index) => {
                                    const files = surat.arsipFiles || [];
                                    ...
                                    return (
                                        <React.Fragment key={surat.id}>
                                            <tr
                                                onClick={() => hasFiles && toggleAccordion(surat.id)}
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-4 text-gray-700">{surat.noFisik}</td>
                                        ...
                                        >
                                            ...
                                            <div className="p-4 space-y-2 text-sm">
                                                <div className="flex justify-between">
                                                    ...
                                                    <span className="font-medium text-gray-800">{surat.noFisik}</span>
                                                </div>
