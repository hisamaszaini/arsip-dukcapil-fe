...
import { Users2, Baby, Skull, FileSearch2, ShieldAlert } from "lucide-react";
    ...
    return (
        <>
            <section className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <StatCard title="Jumlah Pengguna" value={stats.totalUser} icon={Users2} gradientClass="gradient-sky" animationDelay="0s" />
                <StatCard title="Jumlah Akta Kelahiran" value={stats.totalAktaKelahiran} icon={Baby} gradientClass="gradient-emerald" animationDelay="0.1s" />
                <StatCard title="Jumlah Akta Kematian" value={stats.totalAktaKematian} icon={Skull} gradientClass="gradient-slate" animationDelay="0.2s" />
                <StatCard title="Jumlah Surat Kehilangan" value={stats.totalSuratKehilangan} icon={FileSearch2} gradientClass="gradient-amber" animationDelay="0.3s" />
            </section>
            ...
            <section className="grid grid-cols-1 gap-6 lg:grid-cols-3 mt-6">
                <div className="rounded-2xl bg-white p-4 sm:p-6 shadow-lg lg:col-span-2">
                    ...
                    <p className="text-sm text-gray-500">Jumlah arsip yang dibuat dalam 6 bulan terakhir.</p>
                ...
                <div className="rounded-2xl bg-white p-6 shadow-lg lg:col-span-1">
                    <div className="flex items-center justify-between">
                        ...
                        {/* <a href="#" className="text-sm font-semibold text-indigo-600 hover:text-indigo-800">Lihat Semua</a> */}
                    </div>
